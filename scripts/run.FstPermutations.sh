#!/bin/bash
#SBATCH --job-name=run.FstPermutations.snakefile # Job name
...
snakemake -s FstPermutations.snakefile -j 30 --cluster "sbatch -n 1 -t 12:00:00 --mail-type=END,FAIL --mail-user=amtarave@asu.edu"
